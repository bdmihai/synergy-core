...
const QString &AppConfig::iface() const { return m_Interface; }
...
void AppConfig::setInterface(const QString &s)
{
  m_Interface = s;
}
...
QString AppConfig::synergysName() const
{
  return m_SynergysName;
}

QString AppConfig::synergycName() const
{
